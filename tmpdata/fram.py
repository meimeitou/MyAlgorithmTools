...
class MainFrame(Tkinter.Frame):
    ...
    def createFrame(self):
        label_frame_top = Tkinter.LabelFrame(self, text='1')
        # label_frame_top.pack()

        label_frame_center = Tkinter.LabelFrame(self, text='2')
        label_frame_center.pack(fill="x")

        lfc_field_1 = Tkinter.LabelFrame(label_frame_center, text='3')
        ...
        self.lfc_field_1_b = Tkinter.Button(
            lfc_field_1, text="清除：", width=10, height=1, command=self.clearText)
        self.lfc_field_1_b.pack(fill="none", expand=0,
                                side=Tkinter.RIGHT, anchor=Tkinter.SE)
